...
- **Document intelligence** — OCR, VLMs, table extraction 
- **Computer vision pipelines** — object detection, classification, segmentation, tracking  
- **Production engineering** — containers, observability, deployment

Each project is designed to be readable, reproducible, and representative of real-world AI engineering work.
